namespace Haihv.Elis.Tools.Services;
...
public interface IFileService
{
    ...
    // File picker and saver methods
    Task<string?> PickFileAsync(string[]? allowedFileTypes = null, string title = "Chọn file");
    Task<bool> SaveFileAsAsync(string content, string suggestedFileName = "ConnectionInfo.inf", string title = "Lưu file cấu hình");
}